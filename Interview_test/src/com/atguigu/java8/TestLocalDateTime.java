...
public class TestLocalDateTime {
	...
	public void test5() {
		...
		LocalDateTime ldt5 = ldt.with((l) -> {
			...
			if (dow.equals(DayOfWeek.FRIDAY)) {// 周五
				return ldt4.plusDays(3);
			}else if (dow.equals(DayOfWeek.SUNDAY)) {// 周日
	...
	@Test
	public void test2() {
		Instant ins1 = Instant.now();// 默认获取的UTC时区，格林威治时间
		System.out.println(ins1);
		
		OffsetDateTime odt = ins1.atOffset(ZoneOffset.ofHours(8));
		System.out.println(odt);
		
		System.out.println(ins1.toEpochMilli());// 对应的毫米值
